                    ...
                    <form>
                        <div className="mb-10">
                            <input
                                ...
                                className="pl-3 w-full px-3 py-2 border rounded-full focus:outline-none focus:border-blue-500 bg-gray-100"
                                required
                            />
                        </div>
                        <div className="mb-10">
                        ...
                        <div className="mb-10">
                            <textarea
                                ...
                                className="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-blue-500 bg-gray-100"
                                required
                            ></textarea>
                        </div>
                        <button
                            type="submit"
                            className="bg-pink-600 hover:bg-pink-800 text-white font-bold py-2 px-16 rounded-full flex justify-center"
                        >
                            Send
                        </button>
